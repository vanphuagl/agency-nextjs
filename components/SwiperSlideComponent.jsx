  ...
  return (
    <div className="relative" data-scroll-section>
      <Swiper
        ...
        grabCursor={true}
        className="w-full font-neutralFace h-[50vh] md:h-[66vh] relative mt-[40vh] md:mt-[33vh]"
      >
        <SwiperSlide className="flex justify-start flex-col w-fit" style={{display: "flex"}}>
        ...
        <SwiperSlide className="flex justify-start flex-col-reverse w-fit" style={{display: "flex"}}>
          <div className="h-[100%] flex items-end">
            <Image
              alt=""
              src={imageSlider2}
